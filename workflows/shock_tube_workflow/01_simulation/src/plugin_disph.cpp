...
/**
 * @brief DISPH (Density Independent SPH) shock tube plugin.
 * 
 * This plugin implements Density Independent SPH:
 * - Uses density-normalized formulation for better conservation
...
public:
    ...
    std::string get_description() const override {
        return "1D Sod shock tube with DISPH (Density Independent SPH)";
    }
    
    std::string get_version() const override {
        return "1.0.0";  // DISPH implementation
    }
    ...
    void initialize(std::shared_ptr<Simulation<1>> sim,
        ...
        std::cout << "\n=== DISPH SHOCK TUBE (Density Independent SPH) ===\n";
