...
private:
     ...
     */
    static real calculate_min_spacing(const std::vector<SPHParticle>& particles);
    
    /**
     * @brief Calculate maximum sound speed
     */
    static real calculate_max_sound_speed(const std::vector<SPHParticle>& particles);
    
    /**
     * @brief Calculate maximum acceleration magnitude
     */
    static real calculate_max_acceleration(const std::vector<SPHParticle>& particles);
